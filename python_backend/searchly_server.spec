...
all_datas    = flask_datas   + cors_datas   + clip_datas   + torch_datas   + tv_datas   + pil_datas   + numpy_datas   + certifi_datas
all_binaries = flask_bins    + cors_bins    + clip_bins    + torch_bins    + tv_bins    + pil_bins    + numpy_bins    + certifi_bins
all_hiddens  = flask_hiddens + cors_hiddens + clip_hiddens + torch_hiddens + tv_hiddens + pil_hiddens + numpy_hiddens + certifi_hiddens + [
